        ...
        <div class="settings-container">
            ...
            <div class="settings-left">
                ...
                <div class="setting-option">
                    ...
                    <asp:CheckBox ID="chkDarkMode" runat="server" Text="Turn on/off dark mode" />
                </div>
                <div class="setting-option">
                ...
                <div class="setting-option">
                    ...
                    <asp:CheckBox ID="chkButtonClickSound" runat="server" Text="Make Clicking Sounds When Buttons Are Clicked" />
                </div>

                <h3>Notifications</h3>
                <div class="setting-option">
                    <asp:Label ID="lblBibleBasics" runat="server" Text="Bible Basics"></asp:Label>
                    <asp:CheckBox ID="chkBibleBasics" runat="server" Text="Switch on/off Bible Basic Notifications" />
                </div>
                <div class="setting-option">
                    <asp:Label ID="lblResponsibilityUpdates" runat="server" Text="Responsibility Updates"></asp:Label>
                    <asp:CheckBox ID="chkResponsibilityUpdates" runat="server" Text="Switch on/off Responsibility Update Notifications" />
                </div>
            </div>
